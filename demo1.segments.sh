...
## padding and audio: ffmpeg -i input.mp4 -c:v libx264 -preset slow -crf 18 -profile:v high -pix_fmt yuv420p -c:a aac -b:a 384k -movflags +faststart -vf "scale=trunc(iw/2)*2:trunc(ih/2)*2" output.mp4
## no audio, no padding: ffmpeg -i segment7.avi -c:v libx264 -preset slow -crf 18 -profile:v high -pix_fmt yuv420p -an -movflags +faststart segment7.mp4
...
SEGMENT1_TEXT6="Setting the z depth range to 20 micrometers."
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment1.mp4"
##### Finished segment 1
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment2.mp4"
##### Finished segment 2
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment3.mp4"
##### Finished segment 3
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment4.mp4"
##### Finished segment 4

echo -n "Start segment 5"
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment5.mp4"
##### Finished segment 5

echo -n "Start segment 6"
...
echo " and finished, output saved to $VIDEO_OUTPUT_DIR/segment6.mp4"
##### Finished segment 6
